  ...
  return (
    <div className="p-[25px] order-last lg:w-[445px]">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center w-full">
        <div className="flex justify-between items-center bg-Light-grayish-blue px-[24px] py-[22px] rounded-[8px] mb-[16px] lg:w-full lg:mb-0">
          <img
        ...
        <div
          className="flex justify-center items-center px-[90px] py-[20px] bg-Orange rounded-[8px] lg:hover:opacity-50 cursor-pointer lg:h-[55px] lg:w-[270px] lg:px-[75px]"
          onClick={() => {
            productCount !== 0 && setCartData(productCount);
          }}
        >
          <svg className="mr-[14px] lg:m-0" width="50" height="20">
            <path
              fill="#FFFFFF"
